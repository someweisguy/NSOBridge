...
This project uses the Python framework, FastAPI, to host an ASGI server backend. The frontend uses React, the popular Javascript web-development framework. Websockets is used for bidirectional, client-server communication.
