...
import { StartJamComponent, StopJamComponent } from './components/JamControlComponent';
...
function App() {
  ...
  return (
    <div className="App">
      <StartJamComponent /><StopJamComponent /><br /><TimerComponent timerType="jam" />&nbsp;<TimerComponent timerType="game" />
