...
const series: Series = {
  ...
  uuid: "780153bf-dc83-432d-894c-7bc9be1796fb",
  activeBoutUuid: "060f177d-efba-427f-8220-740440aefa6a",
  boutUuids: ["060f177d-efba-427f-8220-740440aefa6a"],
};
...
export const PostJam: Story = {
  parameters: {
    ...
    msw: {
      handlers: [
        http.get("/api/series", () => {
          return HttpResponse.json(mockApiResponse(series));
        }),
        http.get("/api/bout/ruleset", () => {
          return HttpResponse.json(mockApiResponse(rulesetData));
        }),
        ...
        http.get("/api/bout", () => {
          return HttpResponse.json(mockApiResponse<Bout>(bout));
        }),
        http.get("/api/jam", () => {
